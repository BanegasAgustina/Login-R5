-- Migración aditiva sobre el esquema real de PetCare.
-- NULL indica que no existe contraseña local o que el proveedor no compartió email.
-- Conservamos usuarios, hashes, índices y relaciones existentes.
...
-- La comparación binaria evita confundir IDs por mayúsculas/minúsculas.
...
-- Intentos compartidos entre procesos, válidos durante 10 minutos.
